...
class ConeSpinRenderer(BaseRenderer):
    ...
    def __init__(
        ...
        super(ConeSpinRenderer, self).__init__(sections, palette, active=active)
    ...
    def do_render(self):
        ...
        for section in self.SECTIONS:
            for level_index in xrange(len(section.LEVELS)):
                section.set_led(self.CURRENT_ANGLE, level_index, *colour)

        # Move to the next angle/colour
        self.CURRENT_ANGLE = (self.CURRENT_ANGLE + self.DEGREES_PER_STEP) % 360
